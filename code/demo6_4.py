...
def createCSV(pro,code): 
    ...
    M0_A0_C3 = d4.pro_func(d4.C3_func(code,M0_A0))
    result.extend(S_func(code,M0_A0_C3))
    ...
    M0_A1_C3 = d4.pro_func(d4.C3_func(code,M0_A1))
    result.extend(S_func(code,M0_A1_C3))
    ...
    M0_A2_C3 = d4.pro_func(d4.C3_func(code,M0_A2))
    result.extend(S_func(code,M0_A2_C3))
    ...
    M1_A0_C3 = d4.pro_func(d4.C3_func(code,M1_A0))
    result.extend(S_func(code,M1_A0_C3))
#
    ...
    M1_A1_C3 = d4.pro_func(d4.C3_func(code,M1_A1))
    result.extend(S_func(code,M1_A1_C3))
    ...
    M1_A2_C3 = d4.pro_func(d4.C3_func(code,M1_A2))
    result.extend(S_func(code,M1_A2_C3))
    ...
    M2_A0_C3 = d4.pro_func(d4.C3_func(code,M2_A0))
    result.extend(S_func(code,M2_A0_C3))
    ...
    M2_A1_C3 = d4.pro_func(d4.C3_func(code, M2_A1))
    result.extend(S_func(code,M2_A1_C3))
    ...
    M2_A2_C3 = d4.pro_func(d4.C3_func(code,M2_A2))
    result.extend(S_func(code,M2_A2_C3))
...
for i in range(3):
    for j in range(3):
        for m in range(4):
            for n in range(4):
                pd.DataFrame(res[counter],columns=d4.columns).to_csv('./data4/171110_P0'+'_M'+str(i)+'_A'+str(j)+'_C'+str(m)+'_S'+str(n)+'.csv',index=False)
                counter = counter + 1
'''
